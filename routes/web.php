...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'bootstrap'])->group(function () {
    ...
    Route::post('/contacts/deposit/{contact}', 'ContactController@deposit');
    Route::post('/contacts/withdraw/{contact}', 'ContactController@withdraw');
    Route::get('/contacts/transaction/{transaction}', 'ContactController@showTransaction');
    Route::post('/contacts/transaction/save', 'ContactController@saveTransaction');
    Route::get('/contacts/transaction/print/{transaction}', 'ContactController@printTransaction');
    Route::get('/contacts/deposit/{contact}', 'ContactController@deposit');
    Route::get('/contacts/withdraw/{contact}', 'ContactController@withdraw');
    Route::post('/contacts/make/deposit/{contact}', 'ContactController@makeDeposit');
    Route::post('/contacts/make/withdraw/{contact}', 'ContactController@makeWithdraw');
    ...
    Route::get('/reports/deposits', 'ReportController@getDeposits');
