                ...
                <div class="left-col-content login-header">
                    <div style="margin-top: 10%;">
                        <a href="/">
                            ...
                            <?php else: ?>
                            <?php echo e(config('app.name', 'Lucky Aluminium'), false); ?>
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-4" style="text-align: left;">
                        <select class="form-control input-sm" id="change_lang" style="margin: 10px;">
                            ...
                            <option value="<?php echo e($key, false); ?>" <?php if( (empty(request()->lang) && config('app.locale') == $key)
                                || request()->lang == $key): ?>
                                selected
                                <?php endif; ?>
                                >
                    ...
                    <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                        ...
                        <a href="<?php echo e(route('business.getRegister'), false); ?><?php if(!empty(request()->lang)): ?><?php echo e('?lang=' . request()->lang, false); ?> <?php endif; ?>"
                            class="btn bg-maroon btn-flat"><b><?php echo e(__('business.not_yet_registered'), false); ?></b>
                            <?php echo e(__('business.register_now'), false); ?></a>
                        <!-- pricing url -->
                        <?php if(Route::has('pricing') && config('app.env') != 'demo' && $request->segment(1) != 'pricing'): ?>
                        &nbsp; <a
                            href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\PricingController@index'), false); ?>"><?php echo app('translator')->getFromJson('superadmin::lang.pricing'); ?></a>
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php if($request->segment(1) != 'login'): ?>
                        &nbsp; &nbsp;<?php echo e(__('business.already_registered'), false); ?> <a
                            href="<?php echo e(action('Auth\LoginController@login'), false); ?><?php if(!empty(request()->lang)): ?><?php echo e('?lang=' . request()->lang, false); ?> <?php endif; ?>"><?php echo e(__('business.sign_in'), false); ?></a>
                        <?php endif; ?>
                    </div>
