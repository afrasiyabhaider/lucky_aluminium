<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  <?php echo Form::text('contact_id', $contact->contact_id, ['readonly' => 'readonly', 'class' => 'form-control','placeholder' => __('lang_v1.contact_id')]);; ?>
      ...
      <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('custom_field1', __('lang_v1.contact_custom_field1') . ':'); ?>
      ...
      <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('custom_field2', __('lang_v1.contact_custom_field2') . ':'); ?>
      ...
      <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('custom_field3', __('lang_v1.contact_custom_field3') . ':'); ?>
      ...
      <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('custom_field4', __('lang_v1.contact_custom_field4') . ':'); ?>
