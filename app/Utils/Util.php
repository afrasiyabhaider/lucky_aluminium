...
class Util
{
    ...
    */
    ...
    {
        return [ 'received' => __('lang_v1.received'), 'pending' => __('lang_v1.pending'), 'ordered' => __('lang_v1.ordered'),'local_purchase_order' => __('lang_v1.local_purchase_order')];
    }
    ...
    {
        $payment_types = ['cash' => __('lang_v1.cash'),'credit' => __('lang_v1.credit'), 'card' => __('lang_v1.card'), 'cheque' => __('lang_v1.cheque'), 'bank_transfer' => __('lang_v1.bank_transfer'), 'other' => __('lang_v1.other')];
