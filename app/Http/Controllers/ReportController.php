    ...
    public function getDeposits(Request $request){
        ...
        $data = [];
         if ($request->ajax()) {
            ...
            $data = Transaction::whereIn('type', ['deposit', 'withdraw'])->where('business_id', $business_id)->latest()->paginate(15);
         }

        
        $business_locations = BusinessLocation::forDropdown($business_id, true);
        return view('report.deposits', compact('business_locations', 'data'));
