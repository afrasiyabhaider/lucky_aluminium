...
<section class="content">
  ...
  <input type="hidden" id="purchase_id" value="<?php echo e($purchase->id, false); ?>">
        ...
        <div class="row">
            ...
            <div class="<?php if(!empty($default_purchase_status)): ?> col-sm-4 <?php else: ?> col-sm-3 <?php endif; ?>">
              <div class="form-group">
                ...
                <?php echo Form::text('ref_no', $purchase->ref_no, ['class' => 'form-control', 'readonly']);; ?>
            ...
            <div class="<?php if(!empty($default_purchase_status)): ?> col-sm-4 <?php else: ?> col-sm-3 <?php endif; ?>">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <?php echo Form::text('transaction_date', \Carbon::createFromTimestamp(strtotime($purchase->transaction_date))->format(session('business.date_format') . ' ' . 'h:i A'), ['class' => 'form-control', 'readonly', 'required']);; ?>
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
              <?php echo $__env->make('purchase.partials.edit_purchase_entry_row', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
