      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <?php echo Form::text('name', $modifer_set->name, ['class' => 'form-control', 'required', 'placeholder' => __( 'messages.name' ) ]);; ?>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_name_edit[<?php echo e($modifier->id, false); ?>]" 
                        class="form-control" value="<?php echo e($modifier->name, false); ?>" placeholder="<?php echo app('translator')->getFromJson( 'messages.name' ); ?>" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_price_edit[<?php echo e($modifier->id, false); ?>]" 
                      class="form-control input_number" value="<?php echo e(number_format($modifier->sell_price_inc_tax, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>" placeholder="<?php echo app('translator')->getFromJson( 'messages.price' ); ?>" required>
                    </div>
                  </td>
                  <td>
                    <?php if(!$loop->first): ?>
