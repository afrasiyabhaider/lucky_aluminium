    ...
    <table class="table table-bordered table-striped ajax_view" id="product_table">
        <thead>
            <tr>
                ...
                <th style="display:none" ><?php echo app('translator')->getFromJson('product.tax'); ?></th>
                <th><?php echo app('translator')->getFromJson('product.sku'); ?></th>
                <th style="display:none" ><?php echo app('translator')->getFromJson('lang_v1.product_custom_field1'); ?></th>
                <th style="display:none" ><?php echo app('translator')->getFromJson('lang_v1.product_custom_field2'); ?></th>
                <th style="display:none" ><?php echo app('translator')->getFromJson('lang_v1.product_custom_field3'); ?></th>
                <th style="display:none" ><?php echo app('translator')->getFromJson('lang_v1.product_custom_field4'); ?></th>
            </tr>
        </thead>
        <tfoot>
            <tr>
