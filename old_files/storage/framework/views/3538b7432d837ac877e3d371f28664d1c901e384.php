...
<section class="content">
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
		<div class="row">
			...
			<div style="display: none" class="<?php if(!empty($default_purchase_status)): ?> col-sm-4 <?php else: ?> col-sm-3 <?php endif; ?>">
				<div class="form-group">
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					<td colspan="4">
						<div class="form-group">
							<?php echo Form::label('additional_notes','Description of order items'); ?>
