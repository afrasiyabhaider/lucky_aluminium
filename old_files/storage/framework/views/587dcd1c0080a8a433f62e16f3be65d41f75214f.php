...
<div class="modal-body">
  ...
  <div class="row invoice-info">
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        ...
        <?php if(!empty($purchase->contact->email)): ?>
          <br>Email: <?php echo e($purchase->contact->email, false); ?>
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <b><?php echo app('translator')->getFromJson('purchase.purchase_status'); ?>:</b> <?php echo e(ucfirst( $purchase->status ), false); ?><br>
      <b><?php echo app('translator')->getFromJson('purchase.payment_status'); ?>:</b> <?php echo e(ucfirst( $purchase->payment_status ), false); ?><br>
    </div>
  </div>
        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th><?php echo app('translator')->getFromJson('purchase.unit_cost'); ?></th>
          ...
          <?php $__currentLoopData = $purchase->purchase_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td><span class="display_currency" data-currency_symbol="true"><?php echo e($purchase_line->pp_without_discount, false); ?></span></td>
              <td><span class="display_currency"><?php echo e($purchase_line->discount_percent, false); ?></span> %</td>
              ...
              <?php endif; ?>
              <td><span class="display_currency" data-currency_symbol="true"><?php echo e($purchase_line->purchase_price_inc_tax * $purchase_line->quantity, false); ?></span></td>
            </tr>
            <?php 
