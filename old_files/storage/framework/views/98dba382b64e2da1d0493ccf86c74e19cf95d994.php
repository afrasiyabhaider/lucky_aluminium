        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        { data: 'product_custom_field1', name: 'products.product_custom_field1', visible: false  },
                        { data: 'product_custom_field2', name: 'products.product_custom_field2', visible: false  },
