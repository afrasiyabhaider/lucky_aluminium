<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'category.edit_category' ); ?></h4>
    </div>
      ...
      <div class="form-group">
        ...
        <?php if(!empty($parent_categories)): ?>
          <div class="form-group">
            <div class="checkbox">
              <label>
                 <?php echo Form::checkbox('add_as_sub_cat', 1, !$is_parent,[ 'class' => 'toggler', 'data-toggle_id' => 'parent_cat_div' ]);; ?> <?php echo app('translator')->getFromJson( 'category.add_as_sub_category' ); ?>
              </label>
            </div>
          </div>
