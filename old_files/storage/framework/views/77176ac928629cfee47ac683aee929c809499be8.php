            ...
            <div class="row">
                ...
                <?php if($types_of_service->enable_custom_fields == 1): ?>
                    <div class="form-group col-md-6">
                        ...
                        <?php echo Form::text('service_custom_field_1', !empty($transaction) ? $transaction->service_custom_field_1 : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.service_custom_field_1') ]);; ?>
