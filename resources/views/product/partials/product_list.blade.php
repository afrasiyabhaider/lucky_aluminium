    ...
    <table class="table table-bordered table-striped ajax_view" id="product_table">
        <thead>
            <tr>
                ...
                <th style="display:none" >@lang('product.tax')</th>
                <th>@lang('product.sku')</th>
                <th style="display:none" >@lang('lang_v1.product_custom_field1')</th>
                <th style="display:none" >@lang('lang_v1.product_custom_field2')</th>
                <th style="display:none" >@lang('lang_v1.product_custom_field3')</th>
                <th style="display:none" >@lang('lang_v1.product_custom_field4')</th>
            </tr>
        </thead>
        <tfoot>
            <tr>
