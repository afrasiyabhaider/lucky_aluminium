        ...
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $details['expense_details']->total_expenses }}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $details['deposits']->total_deposits }}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $details['withdrawals']->total_withdrawals }}</span>
              </td>
            </tr>
            <tr>
              <td>
