                        ...
                        <div class="info-box bg-yellow">
                            ...
                            <div class="info-box-content">
                              <span class="info-box-text">Credit Limit</span>
                                ...
                                ?>
                              <span class="info-box-number">{{ number_format($total_credit_limit, 0) }} = 100%</span>
                            </div>
                            <div class="info-box-content">
                              ...
                              <span class="info-box-number">{{ number_format($utilized, 0) }}  = {{ $ptg }}% </span>
                            </div>
                            <div class="info-box-content">
                              <span class="info-box-text">Limit Balance</span>
                              <span class="info-box-number">{{ number_format($contact->credit_limit - ($contact->total_invoice - $contact->invoice_received), 0 ) }} = {{ 100 - $ptg }}%</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
                    <div class="info_col_2">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                              ...
                              <span class="info-box-number">{{ number_format($deposits, 0) }}</span>
                            </div>
                            <div class="info-box-content">
                              <span class="info-box-text">Total Withdraws</span>
                              <span class="info-box-number">{{ number_format($withdrawals, 0) }}</span>
                            </div>
                            <div class="info-box-content">
                              <span class="info-box-text">Account Balance</span>
                              <span class="info-box-number">{{ number_format($contact->total_account_balance) }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
